...
def callback(ch, method, properties, body):
    ...
    payload = {
            ...
            "reporter":{"phone":body["reports"][0]["reported_by_data"][0]["mobile"], "email":body["reports"][0]["reported_by_data"][0]["email_id"], "sharing_allowed":True},
            "incident_date_start": body["reports"][0]["created_at"],
            "text":body["reports"][0]["description"],
