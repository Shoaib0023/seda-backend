...
from signals.apps.api.v1.serializers import PrivateCategorySerializer, CategoryHALSerializer
...
class PrivateDepartmentSerializerList(HALSerializer):
    ...
    def get_categories(self, obj):
        ...
        # return list(obj.category_set.filter(is_active=True).values_list('id', flat=True))
        # print(categories)
